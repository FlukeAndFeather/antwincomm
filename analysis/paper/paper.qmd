...
We retained 3 predator clusters from the hierarchical analysis, which we refer to as the ‘pack ice’, ‘marginal ice’, and ‘open water’ communities based on their indicator species (Table 3) and relationships to sea-ice coverage [@fig-seaice]. See Fig. S3 for the gap statistic curve, which we used to identify the optimal number of clusters.
...
The open water community was observed most frequently (56.3% of sites), followed by the marginal ice (22.0%) and pack ice (21.6%) communities (Table 4), with variability between years related to the spatial distribution of sea ice [@fig-predclustannual]. Geographically, in general, the open water community occupied the northern offshore regions and the gap between Elephant Island and the rest of the Shetland Islands [@fig-predclustkde]. We found predators characteristic of the marginal ice community in the western Bransfield Strait and north of Elephant Island. The pack ice community primarily occupied the eastern Bransfield Strait.
