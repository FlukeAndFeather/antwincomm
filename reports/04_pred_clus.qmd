...
What geospatial patterns do we see in the predator communities? The pagophilic predator community (purple) was largely found within the Bransfield Strait and the open ocean predator community (green) further offshore (with the exception of 2015, when it moved more into the Strait). The marginal ice zone predator community (orange) was geographically dynamic, its distribution shifting in space substantially between years. Blue line indicates 65% ice concentration contour during the month of August in each year.
